...
import ice.snow.apatch.APApplication.Companion.SUPERCMD
import ice.snow.apatch.BuildConfig
import ice.snow.apatch.apApp
import ice.snow.apatch.ui.screen.MODULE_TYPE
import java.io.File
...
fun listModules(): String {
    ...
    withNewRootShell{
       newJob().add("cp /data/user/*/ice.snow.apatch/patch/ori.img /data/adb/ap/ && rm /data/user/*/ice.snow.apatch/patch/ori.img")
